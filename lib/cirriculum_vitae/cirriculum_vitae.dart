    ...
    return Padding(
        ...
        child: Flex(
          ...
          children: [
            ...
            _longText(
                'Peter-Vischer-Schule Gymnasium, Nuremberg (2011 - 2021)\n'
                    'Abitur average: 2.4'),
            spaceUndernethSection,
            ...
            _longText(
                'Nuremberg Technical University (since 2023): Energy process technology\n'
            ...
            _longText(
                'City Hunters (October 2022 - May 2023): Lead developer of a mobile Flutter application focused on geocaching\n'
            ...
            _longText(
                'Astrum IT (February - March 2022): Developed a mobile Flutter application as an internship project\n'
                    'Working student at Astrum IT (April - August 2022): Frontend implementation, documentation, and program maintenance'),
            spaceUndernethSection,

            _title('IT knowledge'),
            _longText('Fullstack App Development (since 2021): Flutter (Dart), Java, C#'),
            spaceUndernethSection,

            _title('Language skills'),
            _longText('English (C1), German (native speaker)'),
            spaceUndernethSection,

            _title('Interests'),
            _longText('Cooking, Handball, Volleyball, Windsurfing, Gardening, Philosophy, History'),
            spaceUndernethSection,
