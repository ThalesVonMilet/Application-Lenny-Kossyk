                ...
                children: [
                  ...
                  LongTextBlockWidget(
                    text:
                        ...
                        '\n'
                        'My enthusiasm for sciences stems from their ability to turn ideas into impactful realities. For me, engineering is the ideal path to create meaningful changes in our society —combining creativity, analytical thinking, and practical application to improve lives and push the boundaries of what is possible. I think a perfect project, that exactly shows what I aspire, is your innovation on Battery Manufacturing. I believe that incorporating advanced technologies like laser welding into the battery manufacturing process can significantly enhance both efficiency and performance. Laser welding, with its precision and ability to produce stronger, more reliable connections, could change how we assemble battery components. By using lasers, manufacturers we minimize the risk of defects, reduce energy consumption, and increase the speed of production — all while maintaining high-quality standards. The potential for laser welding to improve the overall battery design is immense, as it can enable better integration of materials and optimize the durability of battery stacks.',
                  ),
